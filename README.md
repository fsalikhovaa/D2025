...
!!! Смотрим соседей. Если еще не отображается ничего - reboot. Проверяем сетевую связанность. Если все работает заряженный снапшот тоже делаем. Насчет снапшотов "Патимат сейчас" ничего не смогла придумать, поэтому "Патимат в день икс" смотри сама, ты - изобретательна :) NO PANIC
